...
Most VOLTHA repositories contain the file `VERISON <https://github.com/opencord/voltha-openolt-adapter/blob/master/VERSION>`_ which contain a semantic version string for builds.
