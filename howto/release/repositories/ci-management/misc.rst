...
- `bbsim-tests.groovy <https://github.com/opencord/ci-management/blob/master/jjb/pipeline/voltha/bbsim-tests.groovy#L35>`_
...
- `jjb/software-upgrades.yaml <https://github.com/opencord/ci-management/blob/master/jjb/software-upgrades.yaml>`_
