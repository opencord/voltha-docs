...
.PHONY: help lint reload Makefile
...
lint: md-lint rst-lint linkcheck

rst-lint: doc_venv
	source ./doc_venv/bin/activate ;\
	doc8 --ignore-path doc_venv --ignore-path _build --ignore-path repos $(SOURCEDIR)
...
OTHER_REPO_DOCS ?= pyvoltha voltha-go voltha-bbsim voltha-openolt-adapter voltha-openonu-adapter voltha-protos
