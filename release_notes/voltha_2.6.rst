...
but other combinations are possible, for example 5 OLTs with 200 ONUs each.
  ...
  132GB RAM, 120GB SSD) deploying a common infrastructure a 3 node ONOS cluster, a 3 note ETCD cluster and a 3 node kafka
  with zookeeper cluster and then 10 VOLTHA stacks comprised of of-agent, core, olt and onu adapter.
