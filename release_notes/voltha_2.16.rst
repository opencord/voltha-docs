...
VOLTHA 2.16 Release Notes
==========================

See the `full release notes on Confluence <https://lf-broadband.atlassian.net/wiki/spaces/HOME/pages/726040579/Release+Notes+for+VOLTHA+Release+2.16>`_
...
`VOLTHA 2.16 <https://lf-broadband.atlassian.net/projects/VOL/versions/10074/tab/release-report-all-issues>`_ release page in Jira.
