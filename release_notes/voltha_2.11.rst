...
.. list-table:: VOLTHA Components
   ...
   * - `voltha-openonu-adapter-go <https://gerrit.opencord.org/gitweb?p=voltha-openonu-adapter-go.git;a=tree>`_
     ...
     - ``2.7.3``
     -
     - `2.7.3! <https://gerrit.opencord.org/plugins/gitiles/voltha-openonu-adapter-go/+/refs/tags/v2.7.2>`__
     - `2.7.3! <https://github.com/opencord/voltha-openonu-adapter-go/tree/v2.7.2>`__
   ...
   * - `voltha-system-tests <https://github.com/opencord/voltha-system-tests/releases/tag/2.9.0>`__
     ...
     - `X <https://github.com/opencord/voltha-system-tests/releases/tag/2.11.10>`__
   * - maclearner
     - ``1.2.1``
     -
     -
