...
- Full support for Turk Telekom triple play workflow with HSIA, Multicast IPTV, VoIP and VoD
- Support for multiple OLTs in a single-VOLTHA stack.
- Support for GPON OLTs, specifically EdgeCore’s ASGvOLT64 OLT
- ONOS controller redundancy, scale and high availability with 3 ONOS + 3 Atomix node deployments
- Support for multiple ONU adaptor instances for scale out
