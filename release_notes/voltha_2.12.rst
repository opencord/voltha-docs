...
.. list-table:: VOLTHA Components
   ...
   * -
     ...
     -
     -
   * - `voltha-docs <http://gerrit.opencord.org/gitweb?p=voltha-docs;a=tree>`_ <br> `docs.voltha.org <https://docs.voltha.org>`_
     - ``2.12.25``
     -
     -
     - `X <https://gerrit.opencord.org/plugins/gitiles/voltctl/+/refs/tags/v2.12.25>`__
     - `X <https://github.com/opencord/voltctl/tree/v2.12.25>`__
     -
     -
     -
     - ``N``
