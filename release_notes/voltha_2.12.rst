...
.. list-table:: Bug Fixes
   ...
   * - `VOL-5175 <https://jira.opencord.org/browser/VOL-5175>`_
     - OLT device ports list in ONOS is empty after rebooting the OLT
   * - `VOL-5195 <https://jira.opencord.org/browser/VOL-5195>`_
     - Missing ANI-G Signal Fail and Signal Degrade alarm notification
   * - `VOL-5209 <https://jira.opencord.org/browser/VOL-5209>`_
     - Open onu adapter crashes during delete device
   * - `VOL-5249 <https://jira.opencord.org/browser/VOL-5249>`_
     - error loading onos image in voltha-onos-sanity_test
   * - `VOL-5236 <https://jira.opencord.org/browser/VOL-5236>`_
     - onu adapter should gracefully reset vlan config fsm on onu down
   * - `VOL-5223 <https://jira.opencord.org/browser/VOL-5223>`_
...
.. list-table:: Test
   ...
   * - Jira
     - Description
   * - `VOL-4829 <https://jira.opencord.org/browser/VOL-4829>`_
...
=======
     - `X <https://gerrit.opencord.org/plugins/gitiles/voltha-openonu-adapter-go/+/refs/tags/v2.11.2>`__
     - `X <https://github.com/opencord/voltha-openonu-adapter-go/tree/v2.11.2>`__
     - `X <https://hub.docker.com/layers/voltha/voltha-openonu-adapter-go/2.11.2/images/sha256-e9484a8963d08748af5766a6a8ce7f7485efb384488bcf93840ecc1142d7ad74?context=explore>`__
>>>>>>> 2431039 ([VOL-5009] Update release notes, jira tickets.)
     -
     -
...
=======
     ...
     - `X <https://github.com/opencord/voltha-openolt-adapter/tree/v4.4.11>`__
     - `X <https://hub.docker.com/layers/voltha/voltha-openolt-adapter/4.4.11/images/sha256-844eac272323dc8bca10880a111957a95839578b3210dd777be5ac9370aaa52e?context=explore>`__
     -
     -
     - ``N`` `VOL-5257 <https://jira.opencord.org/browse/VOL-5257>`_
>>>>>>> 2431039 ([VOL-5009] Update release notes, jira tickets.)
...
.. |jira-opencord|  replace:: replacement https://jira.opencord.org/browser
