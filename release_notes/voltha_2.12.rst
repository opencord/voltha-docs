...
.. list-table:: ONOS Components
   ...
   * - `kafka <https://gerrit.opencord.org/gitweb?p=kafka-onos.git;a=summary>`__
     - `2.13.0 <https://mvnrepository.com/artifact/org.opencord/kafka/2.13.0>`__
     - `X <https://mvnrepository.com/artifact/org.opencord/kafka-api/2.13.0>`__
     - `X <https://mvnrepository.com/artifact/org.opencord/kafka-app/2.13.0>`__
     - `X <https://mvnrepository.com/artifact/org.opencord/kafka/2.13.0>`__
     - `X <https://gerrit.opencord.org/plugins/gitiles/kafka-onos/+/refs/tags/2.13.0>`__
     - `X <https://github.com/opencord/kafka-onos/releases/tag/2.13.0>`__
     - ``N``
