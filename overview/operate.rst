...
Regardless of the OLT the command to ``enable`` an OLT in VOLTHA it is always the same:
...
If you deployed a **Physical POD** then you should now able to reach the internet ore your emulated BNG interface, from
