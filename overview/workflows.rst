...
In SEBA a workflow is a workflow is a collection of subscriber management items like identification, location,
...
and a set of configurations (sadis, etcd, netcfg). Those apps paired the  configuration specified by the
...
and tehn triggering of api's themselves
