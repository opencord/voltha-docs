...
`NUM_OF_ONOS=3 NUM_OF_ATOMIX=3` to any of the workflow command. You can pick the number of instances onf ONOS and ATOMIX
independently. As a good suggestion is 3 or 5.
As an example for the ATT workflow:

.. code:: bash

    WITH_BBSIM="yes" WITH_EAPOL="yes" WITH_DHCP="yes" WITH_RADIUS="yes" CONFIG_SADIS="bbsim" NUM_OF_ONOS=3 NUM_OF_ATOMIX=3 ./voltha up
