...
During code freeze the jenkins jobs test the latest code in master which, given the code freeze state, is the RC
for the release.
...
.. note::
    ...
    omci-lib-go need to be released, it should be done first nad then updated in the components:
