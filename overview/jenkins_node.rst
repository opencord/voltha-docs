...
* Python3 - `<https://docs.python-guide.org/starting/install3/linux/>`_ (if you want to default ``python`` to ``python3``: `<https://linuxconfig.org/how-to-change-from-default-to-alternative-python-version-on-debian-linux>`_)
